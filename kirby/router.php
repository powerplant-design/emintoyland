...
// The PHP built-in server sets SCRIPT_NAME/PHP_SELF to the
// request URI when the router is inside the document root,
// which breaks Kirby's URL/path detection. Reset them so
// Kirby sees index.php as the entry point.
