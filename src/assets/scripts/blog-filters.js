function applyBlogFilter(filter) {
  var container = document.querySelector('[data-filter="container"][data-filter-type="blog"]');
  var tabs = container ? container.parentElement.querySelectorAll('[data-filter="tabs"][data-filter-type="blog"] .filter-tabs__btn') : [];
  ...
  setTimeout(function() {
    ...
    cards.forEach(function(c) {
      var tagStr = c.getAttribute('data-filter') || '';
      var tags = tagStr.split(' ').filter(Boolean);
